...
export default function AboutTeamSection({
  ...
  return (
    <WattaInViewFadeSection
      className="about-page-team-web px-4 pb-6 sm:px-6 sm:pb-8"
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <m.div
          ...
          {...fade}
          viewport={wattaInViewFadeViewport('-24px')}
        ...
        >
          <Link
            ...
            className={cn(
              ...
              'bg-watta-action hover:bg-watta-action focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#145142]',
            )}
          >
            {a.teamGalleryCta}
