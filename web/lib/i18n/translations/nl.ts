...
const nl: SiteTranslations = {
  ...
  adminCategory: {
    ...
    adminPanel: {
      ...
      adminPhones: { title: "Administratornummers", description: "Gebruikers die met deze nummers inloggen zien automatisch het adminpaneel.", phoneLabel: "Telefoonnummer", noteLabel: "Notitie (optioneel)", notePlaceholder: "Naam of rol", addBtn: "Toevoegen", loading: "Laden…", empty: "Nog geen nummers", colPhone: "Nummer", colNote: "Notitie", colAdded: "Toegevoegd", colActions: "Acties", primaryBadge: "Primair", protectedBadge: "Beschermd", deleteBtn: "Verwijderen", deleteAria: "Verwijder {{phone}}", loadError: "Kon admin-nummers niet laden", phoneRequired: "Voer een telefoonnummer in", addError: "Kon nummer niet toevoegen", added: "Nummer toegevoegd", deleteConfirm: "{{phone}} uit adminlijst verwijderen?", deleted: "Nummer verwijderd", error: "Fout" },
