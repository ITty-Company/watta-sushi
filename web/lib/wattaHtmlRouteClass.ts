...
.menu-page-web.watta-site-hero-page-web .welcome-hero-video-stack-web{
  position:relative;width:100%;aspect-ratio:16/8.35;min-height:min(240px,52vw,48vh);overflow:hidden;
}
